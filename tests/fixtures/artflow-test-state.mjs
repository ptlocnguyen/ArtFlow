export function createArtflowFixture() {
  ...
  const purchaseOrders = [
    { id: "po-001", code: "PO-20260624-0001", supplierId: "sup-001", status: "received", paymentStatus: "partial", subtotal: 1800000, discount: 0, shippingFee: 0, total: 1800000, paidAmount: 1000000, creditAppliedAmount: 0, settledAmount: 1000000, returnedAmount: 0, netTotal: 1800000, outstanding: 800000, creditAmount: 0, dueDate: "2026-07-04", invoiceNumber: "INV-001", note: "", createdBy: user.id, receivedAt: "2026-06-24T09:00:00+07:00", createdAt: "2026-06-24T08:30:00+07:00", updatedAt: "2026-06-24T09:00:00+07:00", items: [
      { id: "poi-001", purchaseOrderId: "po-001", productId: products[0].id, sku: products[0].sku, name: products[0].name, quantity: 100, unitCost: 12000, lineTotal: 1200000, createdAt: "2026-06-24T08:30:00+07:00" },
      { id: "poi-002", purchaseOrderId: "po-001", productId: products[1].id, sku: products[1].sku, name: products[1].name, quantity: 100, unitCost: 6000, lineTotal: 600000, createdAt: "2026-06-24T08:30:00+07:00" }
    ] },
    { id: "po-draft-001", code: "PO-DRAFT-001", supplierId: "sup-001", status: "draft", paymentStatus: "unpaid", subtotal: 500000, discount: 0, shippingFee: 0, total: 500000, paidAmount: 0, creditAppliedAmount: 0, settledAmount: 0, returnedAmount: 0, netTotal: 500000, outstanding: 500000, creditAmount: 0, dueDate: "2026-07-20", invoiceNumber: "", note: "Chưa nhận hàng", createdBy: user.id, receivedAt: "", createdAt: "2026-07-10T08:30:00+07:00", updatedAt: "2026-07-10T08:30:00+07:00", items: [
      { id: "poi-draft-001", purchaseOrderId: "po-draft-001", productId: products[3].id, sku: products[3].sku, name: products[3].name, quantity: 50, unitCost: 10000, lineTotal: 500000, createdAt: "2026-07-10T08:30:00+07:00" }
    ] }
  ];
